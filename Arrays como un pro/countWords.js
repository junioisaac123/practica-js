...
el Zen de Python, tu reto es hacer un método que retorne el número de palabras totales que tiene el array.
...
function countWords(array) {
    return array.map(item => item.split(" ")).flat(Infinity).length
  }
let prueba = [
    "Beautiful is better than ugly",
    "Explicit is better than implicit",
